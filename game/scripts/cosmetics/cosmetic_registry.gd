...
const CATALOG_ROWS := [
	...
	["ball_ice", "Ice", CATEGORY_BALL, RARITY_RARE, "Frosted panels with six small crystal facets.", ACQUISITION_GAMEPLAY, 0, 0, {"type": REQUIREMENT_LEVEL_COMPLETE, "level_id": "level_06"}, Color("b8ecff"), 40, false, false],
	["ball_galaxy", "Galaxy", CATEGORY_BALL, RARITY_EPIC, "Star-map dots wrapped by two bright orbital rings.", ACQUISITION_GAMEPLAY, 0, 0, {"type": REQUIREMENT_LEVEL_COMPLETE, "level_id": "level_10"}, Color("7547e8"), 50, false, true],
	["ball_champion", "Champion", CATEGORY_BALL, RARITY_EPIC, "A playable trophy with a gold medal ring and crown fins.", ACQUISITION_GAMEPLAY, 0, 0, {"type": REQUIREMENT_TOTAL_STARS, "stars": 27}, Color("2774d8"), 55, false, false],
	["ball_gold", "Gold", CATEGORY_BALL, RARITY_LEGENDARY, "A metallic match trophy for reaching the 30-star milestone.", ACQUISITION_ACHIEVEMENT, 0, 0, {"type": REQUIREMENT_TOTAL_STARS, "stars": 30}, Color("f3b72a"), 60, false, true],
	["ball_supporter", "Supporter", CATEGORY_BALL, RARITY_EPIC, "A teal-and-gold medallion ball from the Starter Pack.", ACQUISITION_SUPPORTER, 0, 0, {"type": REQUIREMENT_ENTITLEMENT, "entitlement_id": ENTITLEMENT_STARTER_PACK}, Color("1de2bd"), 70, false, true],
	["ball_candy", "Candy Stripe", CATEGORY_BALL, RARITY_COMMON, "Cherry ribbons spiral around a cream playground ball.", ACQUISITION_COIN_PURCHASE, 1000, 0, {"type": REQUIREMENT_COIN_PURCHASE}, Color("ff5f74"), 80, false, true],
	["ball_mint", "Mint Chip", CATEGORY_BALL, RARITY_COMMON, "Cool mint dotted with uneven chocolate chips.", ACQUISITION_COIN_PURCHASE, 1800, 0, {"type": REQUIREMENT_COIN_PURCHASE}, Color("8ce7c2"), 90, false, false],
	["ball_watermelon", "Watermelon", CATEGORY_BALL, RARITY_COMMON, "Juicy pink with a raised green rind and dark seeds.", ACQUISITION_COIN_PURCHASE, 2200, 0, {"type": REQUIREMENT_COIN_PURCHASE}, Color("ff657f"), 100, false, false],
	["ball_sunset", "Sunset Pop", CATEGORY_BALL, RARITY_RARE, "A tiny sunset crossed by warm orbital arcs.", ACQUISITION_COIN_PURCHASE, 4000, 0, {"type": REQUIREMENT_COIN_PURCHASE}, Color("ff7752"), 110, false, false],
	["ball_checker", "Checkerboard", CATEGORY_BALL, RARITY_RARE, "Raised race-day tiles make every spin readable.", ACQUISITION_COIN_PURCHASE, 5500, 0, {"type": REQUIREMENT_COIN_PURCHASE}, Color("f4f0d9"), 120, false, false],
	["ball_cloud", "Cloud Nine", CATEGORY_BALL, RARITY_EPIC, "A sky-blue core wearing soft cartoon cloud puffs.", ACQUISITION_COIN_PURCHASE, 9000, 0, {"type": REQUIREMENT_COIN_PURCHASE}, Color("9bdcff"), 130, false, false],
	["ball_comet", "Comet", CATEGORY_BALL, RARITY_RARE, "A midnight strike ball with three visual-only comet fins.", ACQUISITION_TOKEN_PURCHASE, 0, 50, {"type": REQUIREMENT_TOKEN_PURCHASE}, Color("304a78"), 140, false, true],
	["ball_lava", "Lava Core", CATEGORY_BALL, RARITY_RARE, "A charcoal shell split by bright molten seams.", ACQUISITION_TOKEN_PURCHASE, 0, 80, {"type": REQUIREMENT_TOKEN_PURCHASE}, Color("ff6a19"), 150, false, false],
	["ball_prism", "Prism", CATEGORY_BALL, RARITY_EPIC, "Six pearl facets catch a crossing spectrum ring.", ACQUISITION_TOKEN_PURCHASE, 0, 150, {"type": REQUIREMENT_TOKEN_PURCHASE}, Color("a7f4ff"), 160, false, true],
	["ball_void", "The Void", CATEGORY_BALL, RARITY_LEGENDARY, "Twin impossible horizons orbit an ink-dark core.", ACQUISITION_TOKEN_PURCHASE, 0, 320, {"type": REQUIREMENT_TOKEN_PURCHASE}, Color("151323"), 170, false, true],
	...
	["trail_comet", "Comet Tail", CATEGORY_TRAIL, RARITY_RARE, "A compact silver-blue speed taper.", ACQUISITION_COIN_PURCHASE, 6500, 0, {"type": REQUIREMENT_COIN_PURCHASE}, Color("bdeaff"), 300, false, true],
	...
	["goal_classic", "Classic Flash", CATEGORY_GOAL_EFFECT, RARITY_COMMON, "A sunny full-mouth flash with a clean radial burst.", ACQUISITION_DEFAULT, 0, 0, {"type": REQUIREMENT_DEFAULT}, Color("ffe348"), 410, true, false],
	["goal_confetti", "Confetti", CATEGORY_GOAL_EFFECT, RARITY_RARE, "A wide paper shower across the entire white frame.", ACQUISITION_GAMEPLAY, 0, 0, {"type": REQUIREMENT_TOTAL_STARS, "stars": 18}, Color("52ea8e"), 420, false, false],
	["goal_shockwave", "Shockwave", CATEGORY_GOAL_EFFECT, RARITY_LEGENDARY, "Two arena-sized pulses race out from the goal mouth.", ACQUISITION_ACHIEVEMENT, 0, 0, {"type": REQUIREMENT_TOTAL_STARS, "stars": 30}, Color("45d8ff"), 430, false, true],
